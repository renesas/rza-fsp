...
[FSP v3.0.0](https://github.com/renesas/rza-fsp/releases/tag/v3.0.0)
...
- FSP versions of 3.0.0 and later require a minimum e² studio version of 2024-04.
...
1. Download the FSP with e² studio Installer from the Assets section of the [current release](https://github.com/renesas/rza-fsp/releases/tag/v3.0.0).

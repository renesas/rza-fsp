...
typedef struct
{
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t phyrst_2     : 1;
            uint32_t                    : 2;
            __IOM uint32_t sel_p1reset  : 1;
            __IOM uint32_t sel_p2reset  : 1;
            uint32_t                    : 2;
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t VBSTACHG_STA   : 1;
            __IOM uint32_t VBSTAINT_STA   : 1;
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t VBSTACHG_EN   : 1;
            __IOM uint32_t VBSTAINT_EN   : 1;
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t DST_TC;
        struct
        {
            __IOM uint32_t TC0 : 1;
            __IOM uint32_t TC1 : 1;
            uint32_t           : 30;
        } DST_TC_b;
    };
    union
    {
        __IOM uint32_t DST_SUS;
        struct
        {
            __IOM uint32_t SUS0 : 1;
            __IOM uint32_t SUS1 : 1;
            uint32_t            : 30;
        } DST_SUS_b;
    };
} R_USB01_Type;
...
#define R_USB10_BASE    0x11C70000
...
#define R_USB10    ((R_USB10_Type *) R_USB10_BASE)

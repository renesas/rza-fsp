...
/* Priority Table */
static usb_msg_t * p_usb_scheduler_table_add[USB_PRIMAX][USB_TABLEMAX] USB_BUFFER_PLACE_IN_SECTION;
...
static usb_msg_t * p_usb_scheduler_add_use USB_BUFFER_PLACE_IN_SECTION;

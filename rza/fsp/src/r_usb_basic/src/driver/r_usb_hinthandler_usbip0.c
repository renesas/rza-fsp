 ...
 ******************************************************************************/
usb_utr_t g_usb_cstd_int_msg[USB_NUM_USBIP][USB_INTMSGMAX] USB_BUFFER_PLACE_IN_SECTION; /* Interrupt message */
uint16_t  g_usb_cstd_int_msg_cnt[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;            /* Interrupt message count */
...
void usb_hstd_usb_handler (void)
{
    ...
    irq   = (IRQn_Type) R_FSP_CurrentIrqGet();

...
BSP_ALIGN_VARIABLE(4) usb_utr_t g_usb_shhub_ctrl_mess[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;

/* Data transfer message */
BSP_ALIGN_VARIABLE(4) usb_utr_t g_usb_shhub_data_mess[USB_NUM_USBIP][USB_MAXDEVADDR + 1U] USB_BUFFER_PLACE_IN_SECTION;

/* HUB descriptor */
BSP_ALIGN_VARIABLE(4) uint8_t g_usb_hhub_descriptor[USB_NUM_USBIP][USB_CONFIGSIZE] USB_BUFFER_PLACE_IN_SECTION;

/* HUB status data */
BSP_ALIGN_VARIABLE(4) uint8_t g_usb_hhub_data[USB_NUM_USBIP][USB_MAXDEVADDR + 1U][8] USB_BUFFER_PLACE_IN_SECTION;

/* HUB down port status */
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_down_port[USB_NUM_USBIP][USB_MAXDEVADDR + 1U] USB_BUFFER_PLACE_IN_SECTION;

/* Down port remote wake up */
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_remote[USB_NUM_USBIP][USB_MAXDEVADDR + 1U] USB_BUFFER_PLACE_IN_SECTION;

/* Up-hubaddr, up-hubport, portnum, pipenum */
BSP_ALIGN_VARIABLE(4) usb_hub_info_t g_usb_shhub_info_data[USB_NUM_USBIP][USB_MAXDEVADDR +
                                                                          1U] USB_BUFFER_PLACE_IN_SECTION;
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_number[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION;
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_class_request[USB_NUM_USBIP][5] USB_BUFFER_PLACE_IN_SECTION;

/* Condition compilation by the difference of USB function */
  #if USB_NUM_USBIP == 2
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_class_seq[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_SEQ_0, USB_SEQ_0
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_init_seq[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_SEQ_0, USB_SEQ_0
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_init_port[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_HUB_P1, USB_HUB_P1
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_event_seq[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_SEQ_0, USB_SEQ_0
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_event_port[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_HUB_P1, USB_HUB_P1
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_attach_seq[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{
    USB_SEQ_0, USB_SEQ_0
};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_reset_seq[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{USB_SEQ_0, USB_SEQ_0};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_info[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{USB_SEQ_0, USB_SEQ_0};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_hub_addr[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{USB_SEQ_0, USB_SEQ_0};
BSP_ALIGN_VARIABLE(4) uint16_t g_usb_shhub_process[USB_NUM_USBIP] USB_BUFFER_PLACE_IN_SECTION =
{USB_SEQ_0, USB_SEQ_0};
...
void usb_hhub_open (usb_utr_t * ptr, uint16_t devaddr, uint16_t data2)
{
    ...
    if (USB_MAXHUB != g_usb_shhub_number[ptr->ip])
    {
        ...
        /* Pipe number set */
        g_usb_shhub_info_data[ptr->ip][devaddr].pipe_num = g_usb_hstd_pipe[devaddr].epnum;
...
uint16_t usb_hhub_get_hub_information (usb_utr_t * ptr, uint16_t hubaddr, usb_cb_t complete)
{
    ...
    g_usb_shhub_class_request[ptr->ip][3] = USB_VALUE_47H;
...
uint16_t usb_hhub_get_port_information (usb_utr_t * ptr, uint16_t hubaddr, uint16_t port, usb_cb_t complete)
{
   ...
   #if (BSP_CFG_RTOS == 2)
    qerr        = class_trans_wait_tmo(ptr, (uint16_t) USB_VALUE_3000);
    ptr->status = (uint16_t) qerr;     /* Record the result of the request */
    switch (qerr)
    {
        case USB_OK:                   /* Send CBW */
        {
...
void usb_hhub_task (void)
{
    ...
    while (1)
    {
        /* Receive message */
   #if (BSP_CFG_RTOS == 1)
        err = USB_RTOS_RCV_MSG(USB_HUB_MBX, (usb_msg_t **) &mess);
   #else
   ...
   #if (BSP_CFG_RTOS == 1)
        g_usb_msg_check &= (uint16_t) ~(1 << USB_HUB_TSK);
   #endif
...
static void usb_hhub_enumeration (usb_clsinfo_t * ptr)
{
    ...
    switch (g_usb_shhub_class_seq[ptr->ip])
    {
        ...
        {
            /* Descriptor check */
            retval = usb_hhub_chk_config((uint16_t **) &table, g_usb_shhub_spec[ptr->ip]);
            if (USB_ERROR == retval)
            {
            ...
            retval = usb_hhub_chk_interface((uint16_t **) &table, g_usb_shhub_spec[ptr->ip]);
            if (USB_ERROR == retval)
            {
        ...
        case USB_SEQ_3:
        {
            ...
            if (USB_OK == checkerr)
            {
                if (g_usb_hstd_class_data[ptr->ip][0] < (uint8_t) ((USB_VALUE_32 * 2) + 2))
                {
                ...
                {
                    g_usb_hstd_class_data[ptr->ip][0] = (uint8_t) USB_VALUE_32;
                }
            }
            else
            {
        ...
        case USB_SEQ_5:
        {
            ...
            switch (g_usb_shhub_spec[ptr->ip])
            {
                case USB_FSHUB:        /* Full Speed Hub */
                {
                    ...
                    {
                        retval =
                            usb_hhub_pipe_info(ptr,
                                               g_p_usb_shhub_interface_table[ptr->ip],
        ...
        switch (g_usb_shhub_init_seq[ptr->ip])
        {
            ...
            case USB_SEQ_1:                                 /* Request */
            {
                retval = usb_hhub_port_set_feature(ptr,
                                                   ...
                                                   (usb_cb_t) &usb_hhub_class_request_complete); /* SetFeature request */
            ...
            case USB_SEQ_3:            /* HUB down port initialize */
            {
                retval = usb_hhub_port_clr_feature(ptr,
                                                   ...
                                                   g_usb_shhub_init_port[ptr->ip],
                                                   (uint16_t) USB_HUB_C_PORT_CONNECTION,
                                                   (usb_cb_t) &usb_hhub_class_request_complete); /* Request */
                if (USB_HUB_QOVR == retval)                                                      /* Submit overlap error */
                {
                    usb_hhub_specified_path_wait(mess, (uint16_t) 10);
                }
...
static uint16_t usb_hhub_port_attach (uint16_t hubaddr, uint16_t portnum, usb_clsinfo_t * mess)
{
    ...
    g_usb_hstd_device_addr[ptr->ip] = usb_hhub_get_cnn_devaddr(ptr, g_usb_shhub_hub_addr[ptr->ip], portnum);
    ...
    switch ((uint16_t) (g_usb_hhub_data[ptr->ip][hubaddr][1] & (uint8_t) 0x06))
    {
        case 0x00:
        {
            ...
            r_usb_hstd_hci_set_hub_info(g_usb_shhub_hub_addr[ptr->ip],
                                        portnum,
    ...
    if (0 != devaddr)
    {
        ...
        rootport = usb_hstd_get_rootport(g_usb_shhub_hub_addr[ptr->ip]);
        g_usb_hstd_mgr_mode[rootport] = USB_DEFAULT;
        g_usb_hstd_enum_seq[ptr->ip]  = 0;

        /* Set Device address of the HUB port to HCI */
        r_usb_hstd_hci_set_device_address_of_hub_port(g_usb_shhub_hub_addr[ptr->ip], g_usb_hstd_device_addr[ptr->ip]);
   ...
   #if (BSP_CFG_RTOS == 1)
            /* return to MGR */
            usb_hstd_return_enu_mgr(ptr, USB_OK);
   #endif
    ...
    if (USB_CTRL_END != mess->result)
    {
        USB_PRINTF2("PortAttach result ERROR, Addr:%d, Seq:%d\n",
                    g_usb_shhub_hub_addr[ptr->ip],
                    g_usb_shhub_attach_seq[ptr->ip]);
        usb_hhub_port_detach(ptr, g_usb_shhub_hub_addr[ptr->ip], portnum);
        g_usb_shhub_attach_seq[ptr->ip] = USB_SEQ_0;

        /* Return process */
        if (USB_SEQ_0 == g_usb_shhub_init_seq[ptr->ip])
        {
            g_usb_shhub_process[ptr->ip] = USB_MSG_HUB_EVENT;
        }
        else
        ...
        usb_hhub_specified_path(USB_CTRL_END);
    ...
    switch (g_usb_shhub_attach_seq[ptr->ip])
    {
        ...
        {
            USB_REL_BLK(USB_HUB_MPL, (usb_mh_t) mess);
        ...
        case USB_SEQ_1:                /* GetStatus */
        {
            ...
            /* Keep Reset */
            R_USB_HstdDelayXms((uint16_t) 20);

            /* Send GetStatus */
            usb_hhub_get_port_information(ptr, g_usb_shhub_hub_addr[ptr->ip], portnum, usb_hhub_class_request_complete);
            g_usb_shhub_attach_seq[ptr->ip] = USB_SEQ_2;
            break;
        }
        ...
        case USB_SEQ_3:                /* Device Enumeration */
        {
            ...
            /* Hi-Speed */
            if (0x4 == (g_usb_hhub_data[ptr->ip][hubaddr][1] & 0x4))
            {
                g_usb_hstd_device_speed[ptr->ip] = USB_HSCONNECT;
                USB_PRINTF0(" Hi-Speed Device\n");
                r_usb_hstd_hci_set_hub_info(g_usb_shhub_hub_addr[ptr->ip],
            ...
            else if (0x2 == (g_usb_hhub_data[ptr->ip][hubaddr][1] & 0x2)) /* Low-Speed */
            {
                g_usb_hstd_device_speed[ptr->ip] = USB_LSCONNECT;
                USB_PRINTF0(" Low-Speed Device\n");
                r_usb_hstd_hci_set_hub_info(g_usb_shhub_hub_addr[ptr->ip],
            ...
            rootport = usb_hstd_get_rootport(g_usb_shhub_hub_addr[ptr->ip]);
            g_usb_hstd_mgr_mode[rootport] = USB_DEFAULT;
            g_usb_hstd_enum_seq[ptr->ip]  = USB_SEQ_0;

            /* Set Device address of the HUB port to HCI */
            r_usb_hstd_hci_set_device_address_of_hub_port(g_usb_shhub_hub_addr[ptr->ip],
                                                          g_usb_hstd_device_addr[ptr->ip]);

            /* Start Enumeration */
            usb_hstd_enum_get_descriptor(ptr, (uint16_t) USB_DEVICE_0, (uint16_t) 0);
        ...
        {
            rootport = usb_hstd_get_rootport(g_usb_shhub_hub_addr[ptr->ip]);
            if (USB_DEFAULT != g_usb_hstd_mgr_mode[rootport])
            {
                USB_REL_BLK(USB_HUB_MPL, (usb_mh_t) mess);

                /* Enumeration End */
                g_usb_shhub_down_port[ptr->ip][g_usb_shhub_hub_addr[ptr->ip]] |= USB_BITSET(portnum);
                g_usb_shhub_attach_seq[ptr->ip] = USB_SEQ_0;
            ...
            {
                USB_REL_BLK(USB_HUB_MPL, (usb_mh_t) mess);
                g_usb_shhub_attach_seq[ptr->ip] = USB_SEQ_4; /* Loop Sequencer */
                usb_hhub_specified_path_wait(ptr, 10U);
            }
        ...
        if (USB_TRUE == next_port_check)
        {
            if (g_usb_shhub_event_port[ptr->ip] >= g_usb_shhub_info_data[ptr->ip][hubaddr].port_num)
            {
                ...
                usb_hhub_trans_start(ptr,
                                     ...
                                     (uint32_t) 1,
                                     &g_usb_hhub_data[ptr->ip][hubaddr][0],
                                     (usb_cb_t) &usb_hhub_trans_complete); /* Get Hub and Port Status Change Bitmap */
    ...
    else
    {
        switch (g_usb_shhub_reset_seq[ptr->ip])
        {
            ...
            case USB_SEQ_1:
            {
                ...
                if (USB_OK == retval)
                {
                    usb_cpu_delay_xms((uint16_t) USB_VALUE_60);
...
static void usb_hhub_check_class (usb_utr_t * ptr, uint16_t ** table)
{
    ...
    *table[3]                     = USB_OK;
   ...
   #if USB_IP_EHCI_OHCI == 1
    err = R_USB_HstdSetPipe(table);
    if (USB_OK != err)
    {
        /* Set Pipe Info failure */
        return;
    }
   #endif                              /* #if USB_IP_EHCI_OHCI == 1 */

    /* Descriptor check */
    retval = usb_hhub_chk_config(table, g_usb_shhub_spec[ptr->ip]);
    if (USB_ERROR == retval)
    {
        USB_PRINTF0("### Configuration descriptor error !\n");
        *table[3] = USB_ERROR;
    ...
    /* Interface Descriptor check */
    retval = usb_hhub_chk_interface(table, g_usb_shhub_spec[ptr->ip]);
    if (USB_ERROR == retval)
    {
        USB_PRINTF0("### Interface descriptor error !\n");
        *table[3] = USB_ERROR;
...
static void usb_hhub_trans_start (usb_utr_t * ptr, uint16_t hubaddr, uint32_t size, uint8_t * table, usb_cb_t complete)
{
  ...
  #else                                /* #if USB_IP_EHCI_OHCI == 0 */
    g_usb_shhub_data_mess[ptr->ip][hubaddr].keyword = hubaddr;
  #endif /* #if USB_IP_EHCI_OHCI == 0 */
    ...
    g_usb_shhub_data_mess[ptr->ip][hubaddr].status    = USB_DATA_OK;
...
static void usb_hhub_initial (usb_utr_t * ptr, uint16_t data1, uint16_t data2)
{
    ...
    {
        g_usb_shhub_class_seq[i]  = USB_SEQ_0;
        g_usb_shhub_init_seq[i]   = USB_SEQ_0;
        g_usb_shhub_init_port[i]  = USB_HUB_P1;
        g_usb_shhub_event_seq[i]  = USB_SEQ_0;
        g_usb_shhub_event_port[i] = USB_HUB_P1;
        g_usb_shhub_attach_seq[i] = USB_SEQ_0;
        g_usb_shhub_reset_seq[i]  = USB_SEQ_0;
        g_usb_shhub_info[i]       = USB_SEQ_0;
        g_usb_shhub_hub_addr[i]   = USB_SEQ_0;
        g_usb_shhub_process[i]    = USB_SEQ_0;
    }
}
...
static void usb_hhub_check_request (usb_utr_t * ptr, uint16_t result)
{
    ...
    if (USB_OK == USB_PGET_BLK(USB_HUB_MPL, &p_blf))
    {
        ...
        {
            /* Send message failure */
            USB_REL_BLK(USB_HUB_MPL, (usb_mh_t) cp);
...
static void usb_hhub_selective_detach (usb_utr_t * ptr, uint16_t devaddr)
{
    ...
    if (USB_HCI_HCTYPE_OHCI == p_devinfo->bit.hctype)
    {
        usb_disconnect_done_queue(ptr, devaddr);
    }

    r_usb_hstd_hci_disconnect(ptr, devaddr);

    usb_hstd_set_rootport(devaddr, ptr->ip);

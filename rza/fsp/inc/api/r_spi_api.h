...
typedef enum e_spi_bit_width
{
    ...
    SPI_BIT_WIDTH_17_BITS = (16),      ///< Data bit width is 17 bits (longword)
    SPI_BIT_WIDTH_18_BITS = (17),      ///< Data bit width is 18 bits (longword)
    SPI_BIT_WIDTH_19_BITS = (18),      ///< Data bit width is 19 bits (longword)
    SPI_BIT_WIDTH_20_BITS = (19),      ///< Data bit width is 20 bits (longword)
    SPI_BIT_WIDTH_21_BITS = (20),      ///< Data bit width is 21 bits (longword)
    SPI_BIT_WIDTH_22_BITS = (21),      ///< Data bit width is 22 bits (longword)
    SPI_BIT_WIDTH_23_BITS = (22),      ///< Data bit width is 23 bits (longword)
    SPI_BIT_WIDTH_24_BITS = (23),      ///< Data bit width is 24 bits (longword)
    SPI_BIT_WIDTH_25_BITS = (24),      ///< Data bit width is 25 bits (longword)
    SPI_BIT_WIDTH_26_BITS = (25),      ///< Data bit width is 26 bits (longword)
    SPI_BIT_WIDTH_27_BITS = (26),      ///< Data bit width is 27 bits (longword)
    SPI_BIT_WIDTH_28_BITS = (27),      ///< Data bit width is 28 bits (longword)
    SPI_BIT_WIDTH_29_BITS = (28),      ///< Data bit width is 29 bits (longword)

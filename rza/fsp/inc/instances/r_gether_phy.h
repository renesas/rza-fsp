...
#define GETHER_PHY_CFG_USE_PHY_KSZ8091RNB     (1)
#define GETHER_PHY_CFG_USE_PHY_KSZ8041        (2)
#define GETHER_PHY_CFG_USE_PHY_DP83620        (3)
#define GETHER_PHY_CFG_USE_PHY_KSZ9131RNXI    (4)

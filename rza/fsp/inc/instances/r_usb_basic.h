 ...
 * Macro definitions
 **********************************************************************************************************************/
#define USB_CODE_VERSION_MAJOR    (0U)
#define USB_CODE_VERSION_MINOR    (8U)
...
typedef struct st_usbf_extended_cfg
{
    uint8_t usbf_irq_interrupt_group;  ///< USB interrupt group
} usbf_extended_cfg_t;
#endif                                 /* (BSP_MCU_GROUP_RZT2M == 1) || (BSP_MCU_GROUP_RZA3UL == 1) */
